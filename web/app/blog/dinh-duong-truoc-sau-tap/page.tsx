...
export default function ArticlePage() {
  const schema = { "@context": "https://schema.org", "@type": "Article", headline: "Nữ tập gym nên ăn gì trước và sau buổi tập?", description: metadata.description, image: "https://namlegym.vercel.app/blog/dinh-duong-truoc-sau-tap.png", author: { "@type": "Organization", name: "Foxfit Boutique Wellness Club" }, publisher: { "@type": "Organization", name: "Foxfit Boutique Wellness Club", logo: { "@type": "ImageObject", url: "https://namlegym.vercel.app/foxfit-logo-transparent.png" } }, datePublished: "2026-07-18", dateModified: "2026-07-18" };
